...
% Example Subsection
\subsection{Since camera sensor is square shaped Field of View (FOV) in Horizontal and Vertical directions are same}
\begin{equation*}
...
\subsection{Min no of pixels occupying image}
...
5 MP resolution for sensor area 14\times14 mm ^2 
for sensor area 0.0375*0.0375  no of corresponding pixels are 35.87
